...
PS1=new IScroll('#POROND1',{hScrollbar: false, vScrollbar: false, hScroll: false});PS3=new IScroll('#POROND3',{hScrollbar: false, vScrollbar: false, hScroll: false});PS4=new IScroll('#POROND4',{hScrollbar: false, vScrollbar: false, hScroll: false});PS6=new IScroll('#POROND6',{hScrollbar: false, vScrollbar: false, hScroll: false});PS8=new IScroll('#POROND8',{hScrollbar: false, vScrollbar: false, hScroll: false});PS10=new IScroll('#POROND10',{hScrollbar: false, vScrollbar: false, hScroll: false});PS11=new IScroll('#POROND11',{hScrollbar: false, vScrollbar: false, hScroll: false});RM1=new IScroll('#RECEPT_MEZO1',{hScrollbar: false, vScrollbar: false, hScroll: false});RM2=new IScroll('#HOZZAVALOK',{hScrollbar: false, vScrollbar: false, hScroll: false});RM3=new IScroll('#RECEPT_MEZO3',{hScrollbar: false, vScrollbar: false, hScroll: false});}};var KategoriaID=Array();var KategoriaNEV=Array();var Receptek=Array();var LastPage=[1];var LastLablec=[1];var LastRecept=[0];var LastKategoria=[];var LastKat=0;function Oldal(oldal,lablec)
