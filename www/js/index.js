...
function Megoszt2(MODE,CIM,MSG,KEP)
{var MSG_HTML="<html><head><meta http-equiv='Content-Type'  content='text/html charset=UTF-8' /></head>";MSG_HTML+="<body style='font:12px Arial;'>";MSG_HTML+="<h1 style='font:16px Arial;font-weight:bold;text-decoration:underline;'>"+CIM+"</h1><br>"+MSG;if (KEP){MSG_HTML+="<img src='"+KEP+"'/><br><br>";}
