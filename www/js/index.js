...
var fbLogin=function(){console.log("- FB login -");facebookConnectPlugin.login(
["public_profile"], 
fbLoginSuccess,
function (error){console.log(""+error);} 
)
};var fbLoginSuccess=function (userData){console.log("- FB feed -");var options={"method":"feed", 
...
);};var fbLogin2=function(){console.log("- FB login -");facebookConnectPlugin.login(
["public_profile"], 
fbLoginSuccess2,
function (error){console.log(""+error);} 
)
};var fbLoginSuccess2=function (userData){console.log("- FB feed -");var options={"method":"feed", 
"app_id":"542071045911013",
"caption":APP_NAME+" mobil alkalmazás",
"link":APP_HTTP,
"name": MSG_CIM,
...
MSG_CIM=UZENETEK[uzenetid].cim;MSG_TXT=UZENETEK[uzenetid].uzenet;MSG_IMG=SZERVER+"/app_ilekvar/uzenetek/"+UZENETEK[uzenetid].img;MSG_KEP=UZENETEK[uzenetid].kep;var iOSHTML='<img id="FacebookIkon2" class="shareikon"src="img/facebook.png"ontouchstart=\"Megoszt2(1);\"/>\
<img id="TwitterIkon2"class="shareikon"src="img/twitter.png"ontouchstart=\"Megoszt2(2);\"/>';if (window.device && device.platform && device.platform==="Android"){iOSHTML="";}
var MEGOSZTAS='<div id="MEGOSZTAS" style="margin-bottom:15%;">\
