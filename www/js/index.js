...
onDeviceReady: function(){console.log("--- DeviceReady ---");setTimeout(function(){console.log("--- Reklam indul");Reklam();},500);if (window.device){setTimeout(function(){navigator.splashscreen.hide();console.log("SplashScreen KIKAPCS");}, 3500);}}};var KategoriaID=Array();var KategoriaNEV=Array();var Receptek=Array();var LastPage=[1];var LastLablec=[1];var LastRecept=[0];var LastKategoria=[];var LastKat=0;function Oldal(oldal,lablec)
