...
MSG_CIM=UZENETEK[uzenetid].cim;MST_TXT=UZENETEK[uzenetid].uzenet;MSG_IMG=UZENETEK[uzenetid].kep;var MEGOSZTAS='<div id="MEGOSZTAS" style="display:inline-flex;margin-bottom:15%;">\
